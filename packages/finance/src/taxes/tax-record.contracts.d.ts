import type { CurrencyCode, FinancialStatus, FiscalYearId, IsoDate, OwnerId, OwnerQuery, PageResult } from "../finance.types.js";
...
export interface CreateTaxRecordInput { readonly ownerId: OwnerId; readonly taxProfileId: TaxProfileId; readonly financialYear: FiscalYearId; readonly recordType: string; readonly amount: Money; readonly recordedOn: IsoDate; }
export interface UpdateTaxRecordInput { readonly financialYear?: FiscalYearId; readonly recordType?: string; readonly amount?: Money; readonly recordedOn?: IsoDate; }
export interface TaxRecordListQuery extends OwnerQuery { readonly taxProfileId?: TaxProfileId; readonly financialYear?: FiscalYearId; }
export interface TaxRecordsByFinancialYearQuery extends OwnerQuery { readonly financialYear: FiscalYearId; }
